...
public class FragmentTabsPager extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.chessyoup.R.layout.fragment_tabs_pager);
		...
		mTabsAdapter.addTab(mTabHost.newTabSpec("simple")
				.setIndicator("Simple"), TestFragment.class, null);
		mTabsAdapter.addTab(
	...
	public static class TestFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View v = inflater.inflate(R.layout.roaster, container, false);            
            return v;
        }
    }
}
